...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserAdapter.ViewHolder holder, int position) {
        ...
        Glide.with(holder.binding.getRoot()).load("https://static.vecteezy.com/system/resources/previews/000/439/863/original/vector-users-icon.jpg").into(holder.binding.ivUserThumbnail);
    }
